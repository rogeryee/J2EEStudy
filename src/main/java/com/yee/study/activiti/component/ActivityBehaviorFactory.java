...
public class ActivityBehaviorFactory extends DefaultActivityBehaviorFactory {
	...
	public ServiceTaskDelegateExpressionActivityBehavior createTiLnkServiceTaskBehavior(ServiceTask serviceTask) {
		...
		if (ImplementationType.IMPLEMENTATION_TYPE_DELEGATEEXPRESSION
			...
			delegateExpression = expressionManager.createExpression("${tiLnkServiceTask}");
		}		 
